...
1. Run `npm start -- --hmr`  
2. Start debugging dotnet core app
3. Open browser page http://localhost:5000

HMR doesnt seem to work
Now how to have a single config for port/url to be linked in the aspnetcoreapp.
